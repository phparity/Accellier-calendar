...
const FilterUserEvent = (props) => {
  ...
  const {
    handleFilterCloseButton,
    filterValue,
    handleFilterSelection,
    handleEventFilteredData,
  } = props;
  return (
    <Fragment>
      ...
      <Dropdown.Menu>
            ...
            filterValue?.map((item, i) => {
              return (
                <Dropdown.Item
                  key={item?.id}
                  as="button"
                  onClick={() => handleFilterSelection(item, i)}
                >
                  ...
                  <div className="profile_otr">
                    <div className="profile_box">
                      ...
                      <div className="profile_text">
                        ...
                        <p className="user_post">{item?.userPost}</p>
                      </div>
                    </div>
                    ...
                    <div className="checkbox_wrap">
                      <img
                        className={`checkIcon`}
                        src={item?.isFilter ? CheckIcon : BlankCheckIcon}
                        alt="img"
                      />
                    </div>
                  </div>
        ...
        <div className="btn-grp event_action_btn">
          ...
          <Button
            ...
            onClick={(e) => handleEventFilteredData(e)}
          >
            <Trans>Done</Trans>
          </Button>
        </div>
...
FilterUserEvent.propTypes = {
  handleFilterCloseButton: PropTypes.func,
  filterValue: PropTypes.arrayOf(PropTypes.object),
  handleFilterSelection: PropTypes.func,
  handleEventFilteredData: PropTypes.func
};
